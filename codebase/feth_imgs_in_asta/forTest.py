...
dataset_folder = "/home/haoran/Documents/Thesis/Thesis_codes/data_collection"
seconds = time.time()
local_time = time.ctime(seconds)
add_time = 'test_data' + str(local_time) 
...
try:
    while True:
        ...
        save_imu_cam(d_time, dataset_folder, acceleration, angular_velocity)
