...
# output_labels =  'segments/test_dataset/labels_database.csv'
# output_segments = 'segments/test_dataset/segments_database.csv'
# output_timestamps = 'segments/test_dataset/timestamps_database.csv'
# output_positions = 'segments/test_dataset/positions_database.csv'

output_centers = 'segments/test_dataset/centers_database.csv'
# if not exists, create the folder
if not os.path.exists('segments/test_dataset'):
    os.makedirs('segments/test_dataset')
...
#     pass
with open(output_centers, mode='w') as file:
    pass
...
for file_anno in tqdm(files):
    ...
    segments_recount = 0
    for mask, label, score, bbox in zip(masks, labels, scores, bboxes):
        ...
        # get center of the mask in camera frame
        ...
        pcd_in_world = np.asarray(segment_pcd.points)
    ...
    #search_param=o3d.geometry.KDTreeSearchParamHybrid(radius=0.1, max_nn=30))
        ...
        # save center in csv
        # Writing data to CSV
        # with open(output_centers, mode='a', newline='') as file:
        #     writer = csv.writer(file, delimiter=' ')
        #     writer.writerow([image_id, segments_recount, center[0], center[1]])
